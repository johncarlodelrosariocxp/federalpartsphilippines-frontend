    ...
    <div className="min-h-screen bg-black text-gray-100">
      <div className="container-custom py-8 pt-30 md:pt-40">
        ...
        <div className="text-center mb-16">
          <h1 className="font-bebas text-5xl md:text-6xl mb-6 text-white">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div className="order-1 lg:order-2">
            <h2 className="font-bebas text-4xl mb-6 text-white">
        ...
        <div className="mb-20">
          <h2 className="font-bebas text-4xl mb-12 text-center text-white">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  <div>
                    ...
                    <p className="text-gray-300">+63 (44) 123-4567</p>
                    <p className="text-gray-400 text-sm">
                      Globe: +63 917 123 4567
                    </p>
                  </div>
                </div>
