            ...
            <div>
              <div className="mb-6">
                <div className="flex items-start justify-between gap-4 mb-4">
                  <h1 className="text-3xl lg:text-4xl font-bold text-white flex-1">
                    {product.name}
                  </h1>
                </div>
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {product.category && (
                    <span className="inline-flex items-center gap-1 px-3 py-1.5 text-sm font-medium bg-blue-900/50 text-blue-300 rounded-full">
                  ...
                  {product.brand && (
                    <span className="px-3 py-1.5 text-sm font-medium bg-gray-700 text-gray-300 rounded-full">
                      {product.brand}
                    </span>
                  )}
                  {product.sku && (
              ...
              {/* Status Indicator */}
              <div className="mb-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg font-medium bg-green-900/30 text-green-400">
